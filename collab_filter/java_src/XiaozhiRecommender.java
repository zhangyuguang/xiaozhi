...
public class XiaozhiRecommender implements Recommender {
  ...
  public XiaozhiRecommender() throws TasteException, IOException {
    this(new FileDataModel(readResourceToTempFile("ratings.dat")));
  }

  public XiaozhiRecommender(DataModel model)
  ...
  static File readResourceToTempFile(String resourceName) throws IOException {
    ...
    try {
      URL resourceURL = Resources.getResource(XiaozhiRecommender.class, absoluteResource);
